console.log("Khanh ne");


function tinhThue() {
    var hoTen = document.getElementById("hoTen").value;
    var thuNhapNam = parseFloat(document.getElementById("tongThuNhap").value);
    ...
    if (thuNhapChiuThue <= 60000000) {
      ...
      thue =60000000 * 0.05 + 60000000 * 0.1 + 90000000 * 0.15 +
        (thuNhapChiuThue - 210000000) * 0.2;
    } else if (thuNhapChiuThue <= 624000000) {
      thue =60000000 * 0.05 +60000000 * 0.1 + 90000000 * 0.15 + 174000000 * 0.2 +
      ...
      thue = 60000000 * 0.05 + 60000000 * 0.1 + 90000000 * 0.15 + 174000000 * 0.2 + 240000000 * 0.25 + 336000000 * 0.3 +
        (thuNhapChiuThue - 960000000) * 0.35;
    }
  
    // Hiển thị kết quả
    var ketQua = new Intl.NumberFormat("en-US").format(thue);
    document.getElementById("ketQua").innerText = `${hoTen}, Thuế Thu Nhập Cá Nhân Phải Trả: ${ketQua} VNĐ`;
  }